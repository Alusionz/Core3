...
object_weapon_melee_2h_sword_2h_sword_maul = object_weapon_melee_2h_sword_shared_2h_sword_maul:new {
	...
	healthAttackCost = 10, -- 99
	actionAttackCost = 10, -- 28
	mindAttackCost = 5, -- 17
	forceCost = 0,

	pointBlankRange = 0,
	pointBlankAccuracy = 30, -- -36

	idealRange = 3,
	idealAccuracy = 30, -- -36

	maxRange = 4,
	maxRangeAccuracy = 30, --36

	minDamage = 3110, --110 base
	maxDamage = 4450, --450 base

	attackSpeed = 0.6, --5.6 base
