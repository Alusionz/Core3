...
object_draft_schematic_weapon_lightsaber_lightsaber_one_hand_gen3 = object_draft_schematic_weapon_lightsaber_shared_lightsaber_one_hand_gen3:new {
   ...
   ingredientSlotType = {0, 3, 0, 0, 0, 0},
   resourceTypes = {"metal_ferrous", "object/tangible/component/weapon/lightsaber/shared_lightsaber_refined_crystal_pack.iff", "aluminum_titanium", "petrochem_inert_polymer", "gas_inert_culsion", "copper_polysteel"},
   resourceQuantities = {35, 1, 20, 25, 25, 25},
