...
object_draft_schematic_weapon_lightsaber_lightsaber_two_hand_gen3 = object_draft_schematic_weapon_lightsaber_shared_lightsaber_two_hand_gen3:new {
   ...
   -- Pre-P9: Gen3 = materials + force crystal + Gen2 two-hand saber
   ...
   resourceTypes = {"metal_ferrous", "object/tangible/component/weapon/lightsaber/shared_lightsaber_module_force_crystal.iff", "aluminum_titanium", "petrochem_inert_polymer", "gas_inert_culsion", "copper_polysteel", "object/weapon/melee/2h_sword/crafted_saber/shared_sword_lightsaber_two_handed_gen2.iff"},
